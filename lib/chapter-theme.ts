...
const themes: Record<string, ChapterTheme> = {
  ...
  // ---- Physics · Class 11 ----
  "units-measurements": { primary: "sky-500", secondary: "blue-500", accent: "sky-100", name: "measure", gradient: "from-sky-500 to-blue-500", hex: { primary: "#0ea5e9", secondary: "#3b82f6" } },
  kinematics: { primary: "blue-500", secondary: "indigo-500", accent: "blue-100", name: "motion", gradient: "from-blue-500 to-indigo-500", hex: { primary: "#3b82f6", secondary: "#6366f1" } },
  "laws-of-motion": { primary: "indigo-500", secondary: "violet-500", accent: "indigo-100", name: "force", gradient: "from-indigo-500 to-violet-500", hex: { primary: "#6366f1", secondary: "#8b5cf6" } },
  "work-energy-power": { primary: "emerald-500", secondary: "teal-500", accent: "emerald-100", name: "energy", gradient: "from-emerald-500 to-teal-500", hex: { primary: "#10b981", secondary: "#14b8a6" } },
  "rotational-motion": { primary: "violet-500", secondary: "purple-500", accent: "violet-100", name: "spin", gradient: "from-violet-500 to-purple-500", hex: { primary: "#8b5cf6", secondary: "#a855f7" } },
  gravitation: { primary: "blue-600", secondary: "indigo-600", accent: "blue-100", name: "orbit", gradient: "from-blue-600 to-indigo-600", hex: { primary: "#2563eb", secondary: "#4f46e5" } },
  "mechanical-properties-solids": { primary: "teal-500", secondary: "emerald-500", accent: "teal-100", name: "elastic", gradient: "from-teal-500 to-emerald-500", hex: { primary: "#14b8a6", secondary: "#10b981" } },
  "mechanical-properties-fluids": { primary: "cyan-500", secondary: "blue-500", accent: "cyan-100", name: "flow", gradient: "from-cyan-500 to-blue-500", hex: { primary: "#06b6d4", secondary: "#3b82f6" } },
  "thermal-properties-matter": { primary: "orange-500", secondary: "red-500", accent: "orange-100", name: "heat", gradient: "from-orange-500 to-red-500", hex: { primary: "#f97316", secondary: "#ef4444" } },
  thermodynamics: { primary: "red-500", secondary: "orange-500", accent: "red-100", name: "engine", gradient: "from-red-500 to-orange-500", hex: { primary: "#ef4444", secondary: "#f97316" } },
  "kinetic-theory": { primary: "rose-500", secondary: "red-500", accent: "rose-100", name: "gas", gradient: "from-rose-500 to-red-500", hex: { primary: "#f43f5e", secondary: "#ef4444" } },
  oscillations: { primary: "fuchsia-500", secondary: "purple-500", accent: "fuchsia-100", name: "swing", gradient: "from-fuchsia-500 to-purple-500", hex: { primary: "#d946ef", secondary: "#a855f7" } },
  waves: { primary: "cyan-500", secondary: "sky-500", accent: "cyan-100", name: "ripple", gradient: "from-cyan-500 to-sky-500", hex: { primary: "#06b6d4", secondary: "#0ea5e9" } },

  // ---- Physics · Class 12 ----
  "electric-charges-fields": { primary: "amber-500", secondary: "orange-500", accent: "amber-100", name: "charge", gradient: "from-amber-500 to-orange-500", hex: { primary: "#f59e0b", secondary: "#f97316" } },
  "electrostatic-potential-capacitance": { primary: "indigo-500", secondary: "blue-500", accent: "indigo-100", name: "field", gradient: "from-indigo-500 to-blue-500", hex: { primary: "#6366f1", secondary: "#3b82f6" } },
  "current-electricity": { primary: "amber-500", secondary: "yellow-500", accent: "amber-100", name: "current", gradient: "from-amber-500 to-yellow-500", hex: { primary: "#f59e0b", secondary: "#eab308" } },
  "moving-charges-magnetism": { primary: "violet-600", secondary: "purple-500", accent: "violet-100", name: "lorentz", gradient: "from-violet-600 to-purple-500", hex: { primary: "#7c3aed", secondary: "#a855f7" } },
  "magnetism-matter": { primary: "slate-500", secondary: "violet-500", accent: "slate-100", name: "magnet", gradient: "from-slate-500 to-violet-500", hex: { primary: "#64748b", secondary: "#8b5cf6" } },
  "electromagnetic-induction": { primary: "orange-500", secondary: "amber-500", accent: "orange-100", name: "induce", gradient: "from-orange-500 to-amber-500", hex: { primary: "#f97316", secondary: "#f59e0b" } },
  "alternating-current": { primary: "cyan-500", secondary: "teal-500", accent: "cyan-100", name: "ac", gradient: "from-cyan-500 to-teal-500", hex: { primary: "#06b6d4", secondary: "#14b8a6" } },
  "electromagnetic-waves": { primary: "fuchsia-500", secondary: "purple-600", accent: "fuchsia-100", name: "spectrum", gradient: "from-fuchsia-500 to-purple-600", hex: { primary: "#d946ef", secondary: "#9333ea" } },
  "ray-optics": { primary: "cyan-500", secondary: "blue-500", accent: "cyan-100", name: "lens", gradient: "from-cyan-500 to-blue-500", hex: { primary: "#06b6d4", secondary: "#3b82f6" } },
  "wave-optics": { primary: "purple-500", secondary: "fuchsia-500", accent: "purple-100", name: "fringe", gradient: "from-purple-500 to-fuchsia-500", hex: { primary: "#a855f7", secondary: "#d946ef" } },
  "dual-nature-radiation": { primary: "indigo-500", secondary: "violet-600", accent: "indigo-100", name: "photon", gradient: "from-indigo-500 to-violet-600", hex: { primary: "#6366f1", secondary: "#7c3aed" } },
